...
/**
 * Class GolfServiceProvider
 *
 * @package NextDeveloper\Golf
 */
class GolfServiceProvider extends AbstractServiceProvider
{
    /**
     * @var bool
     */
    ...
    public function boot()
    {
        $this->publishes(
            [
            __DIR__.'/../config/golf.php' => config_path('golf.php'),
            ], 'config'
        );

        $this->loadViewsFrom($this->dir.'/../resources/views', 'Golf');
    ...
    public function register()
    {
        ...
        $this->mergeConfigFrom(__DIR__.'/../config/golf.php', 'golf');
